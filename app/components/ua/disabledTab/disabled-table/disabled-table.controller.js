(function () {
    ...
    uaDisabledTableController.$inject = ['$scope', 'ProjectService', 'DTOptionsBuilder', 'ConfirmModalService', 'MessageBoxService', 'ModalService', 'UAService', 'UserService'];

    function uaDisabledTableController($scope, ProjectService, DTOptionsBuilder, ConfirmModalService, MessageBoxService, ModalService, UAService, UserService) {
