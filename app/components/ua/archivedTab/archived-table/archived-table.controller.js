(function () {
    ...
    uaArchivedTableController.$inject = ['$scope', 'ProjectService', 'DTOptionsBuilder', 'ConfirmModalService', 'MessageBoxService', 'ModalService', 'UAService', 'UserService'];

    function uaArchivedTableController($scope, ProjectService, DTOptionsBuilder, ConfirmModalService, MessageBoxService, ModalService, UAService, UserService) {
